...
# From $(cat grep WORKSPACE -Eo "(http|https)://[a-zA-Z0-9./?=_%:-]*" | sort -u
bazel_external_uris="
	...
	https://mirror.bazel.build/github.com/jmillikin/rules_m4/releases/download/v0.1/m4-gnulib-788db09a9f88abbef73c97e8d7291c40455336d8.tar.xz
"
